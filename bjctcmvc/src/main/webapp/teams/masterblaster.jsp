...
<head>
<meta charset=utf-"8" />
<title>BJTCT - MASTER BLASTER</title>
...
<style type="text/css">
#teamPageSubMenu a {padding:0 5px;}
</style>
...
<div id="wrapper">
    ...
    <section id="subMenuQuickLinks">
        <div id="teamHdr">
            <p>Bangalore Jain Tennis Cricket Trust <b style="color: #b41b00; font-size: 1em; margin: 0 8px;">/</b> Master Blaster</p>
        </div>
